...
// XXX: There is also SDLK_SYSREQ, which is the same key...
SDLK_PRINT,	// PS2KEY_PrintScreen	12	// [PrintScreen]
SDLK_BACKQUOTE,	// PS2KEY_HanZen		  13	// [半角/全角 漢字]
...
SDLK_QUOTE,	// PS2KEY_Colon		    36	// [: *]
// XXX: There is also SDLK_SEMICOLON, which are on the same key in US layout...
SDLK_COLON,	// PS2KEY_Semicolon	  37	// [; +]
SDLK_COMMA,	// PS2KEY_Kamma		    38	// [, <]
SDLK_MINUS,	// PS2KEY_minus		    39	// [- =]
SDLK_PERIOD,	// PS2KEY_Dot			    40	// [. >]
SDLK_SLASH,	// PS2KEY_Question	  41	// [/ ?]
SDLK_LEFTBRACKET,	// PS2KEY_AT			    42	// [@ `]
SDLK_RIGHTBRACKET,	// PS2KEY_L_brackets	43	// [[ {]
SDLK_BACKSLASH,	// PS2KEY_Pipe		    44	// [\ |]
SDLK_UNKNOWN,	// PS2KEY_R_brackets	45	// [] }]
SDLK_EQUALS,	// PS2KEY_Hat			    46	// [^ ~]
...
SDLK_UNKNOWN,	// PS2KEY_Pipe2 58  // [\ |] (USキーボード用)
SDLK_UNKNOWN,
SDLK_UNKNOWN,
SDLK_UNKNOWN,
SDLK_UNKNOWN,
...
SDLK_UNKNOWN,
SDLK_UNKNOWN,
SDLK_KP_EQUALS,	// PS2KEY_PAD_Equal	94	// [=]
