10 PRINT "PROGRAM FILE 143: ERROR - TWO ARGUMENTS IN LIST FOR"
15 PRINT "        SIN FUNCTION."
20 PRINT "    ANSI STANDARD 7.2, 7.4, 8.2, 8.4"
30 PRINT
40 PRINT "SECTION 143.1: ERROR - TWO ARGUMENTS IN LIST FOR"
45 PRINT "        SIN FUNCTION."
50 PRINT
60 PRINT "THIS SECTION TESTS WHAT HAPPENS WHEN THE SIN FUNCTION IS"
70 PRINT "INVOKED WITH TWO ARGUMENTS, INSTEAD OF ONE AS SPECIFIED"
...
230 PRINT
240 PRINT "ABOUT TO ATTEMPT INVOCATION OF SIN."
250 LET A=SIN(1,1)
