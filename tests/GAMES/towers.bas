...
590 FOR R=1 TO 7
600 FOR C=1 TO 3
610 IF TT(R,C)=D THEN 640
620 NEXT C: NEXT R
630 R=7:C=3
640 FOR Q=R TO 1 STEP -1
645 IF TT(Q,C)=0 THEN 660
650 IF TT(Q,C)<D THEN 680
660 NEXT Q
670 GOTO 700
...
1250 Z=10
1260 FOR J=1 TO 3
1270 IF TT(K,J)=0 THEN 1330
1280 PRINT TAB(Z-INTT(TT(K,J)/2));
1290 FOR V=1 TO TT(K,J)
1300 PRINT "*";
1310 NEXT V
1320 GOTO 1340
1330 PRINT TAB(Z);"*";
