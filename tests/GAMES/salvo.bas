...
1030 REM
1032 DEF FNA(K)=(5-K)*3-2*INT(K/4)+SGN(K-1)-1
1033 DEF FNB(K)=K+INT(K/4)-SGN(K-1)
1040 DIM AA(10,10),BB(10,10),CC(7),DD(7),EE(12),FF(12),GG(12),HH(12),KK(10,10)
1050 Z8=0
1060 FOR W=1 TO 12
1070 EE(W)=-1
1080 HH(W)=-1
...
1370 FF(Z+FNA(K))=X+V2*Z
1380 GG(Z+FNA(K))=Y+V*Z
1390 NEXT Z
1400 U8=FNA(K)
...
1430 IF SQR((FF(Z3)-FF(Z2))^2 + (GG(Z3)-GG(Z2))^2) < 3.59 THEN 1260
1440 NEXT Z3
1450 NEXT Z2
1460 FOR Z=0 TO FNB(K)
1470 AA(FF(Z+U8),GG(Z+U8))=.5+SGN(K-1)*(K-1.5)
1480 NEXT Z
1490 NEXT K
...
1750 FOR Z=1 TO 5
1760 PRINT FF(Z);GG(Z)
1770 NEXT Z
1780 PRINT "CRUISER"
1790 PRINT FF(6);GG(6)
1800 PRINT FF(7);GG(7)
1810 PRINT FF(8);GG(8)
1820 PRINT "DESTROYER<A>"
1830 PRINT FF(9);GG(9)
1840 PRINT FF(10);GG(10)
1850 PRINT "DESTROYER<B>"
1860 PRINT FF(11);GG(11)
1870 PRINT FF(12);GG(12)
1880 GOTO 1710
1890 C=0
...
2380 GOTO 2300
2390 IF AA(X,Y)>10 THEN 2440
2400 CC(W)=X
2410 DD(W)=Y
2420 NEXT W
2430 GOTO 2460
2440 PRINT "YOU SHOT THERE BEFORE ON TURN";AA(X,Y)-10
2450 GOTO 2300
2460 FOR W=1 TO A
2470 IF AA(CC(W),DD(W))=3 THEN 2540
2480 IF AA(CC(W),DD(W))=2 THEN 2560
2490 IF AA(CC(W),DD(W))=1 THEN 2580
2500 IF AA(CC(W),DD(W))=.5 THEN 2600
2510 AA(CC(W),DD(W))=10+C
2520 NEXT W
2530 GOTO 2620
...
3310 IF BB(X,Y)>10 THEN 3210
3320 FOR Q9=1 TO W
3330 IF FF(Q9)<>X THEN 3350
3340 IF GG(Q9)=Y THEN 3210
3350 NEXT Q9
3360 W=W+1
3370 GOTO 3180
3380 IF K$<>"YES" THEN 3420
3390 FOR Z5=1 TO A
3400 PRINT FF(Z5);GG(Z5)
3410 NEXT Z5
3420 FOR W=1 TO A
3430 IF BB(FF(W),GG(W))=3 THEN 3500
3440 IF BB(FF(W),GG(W))=2 THEN 3520
3450 IF BB(FF(W),GG(W))=1 THEN 3560
3460 IF BB(FF(W),GG(W))=.5 THEN 3540
3470 BB(FF(W),GG(W))=10+C
3480 NEXT W
3490 GOTO 1950
...
3570 FOR Q=1 TO 12
3580 IF EE(Q)<>-1 THEN 3730
3590 EE(Q)=10+C
3600 HH(Q)=BB(FF(W),GG(W))
3610 M3=0
3620 FOR M2=1 TO 12
3630 IF HH(M2)<>HH(Q) THEN 3650
3640 M3=M3+1
3650 NEXT M2
3660 IF M3<>INT(HH(Q)+.5)+1+INT(INT(HH(Q)+.5)/3) THEN 3470
3670 FOR M2=1 TO 12
3680 IF HH(M2)<>HH(Q) THEN 3710
3690 EE(M2)=-1
3700 HH(M2)=-1
3710 NEXT M2
3720 GOTO 3470
...
3750 FOR Q=1 TO 12
3760 PRINT "EE(";Q;") =";EE(Q)
3770 PRINT "HH(";Q;") =";HH(Q)
3780 NEXT Q
3790 STOP
...
3850 NEXT R
3860 FOR U=1 TO 12
3870 IF EE(U)<10 THEN 4020
3880 FOR R=1 TO 10
3890 FOR S=1 TO 10
3900 IF BB(R,S)<10 THEN 3930
3910 KK(R,S)=-10000000
3920 GOTO 4000
3930 FOR M=SGN(1-R) TO SGN(10-R)
3940 FOR N=SGN(1-S) TO SGN(10-S)
3950 IF N+M+N*M=0 THEN 3980
3960 IF BB(R+M,S+N)<>EE(U) THEN 3980
3970 KK(R,S)=KK(R,S)+EE(U)-S*INT(HH(U)+.5)
3980 NEXT N
3990 NEXT M
4000 NEXT S
4010 NEXT R
...
4090 Q9=1
4100 FOR M=1 TO A
4110 IF KK(FF(M),GG(M))>=KK(FF(Q9),GG(Q9)) THEN 4130
4120 Q9=M
4130 NEXT M
4131 IF R>A THEN 4140
4132 IF R=S THEN 4210
4140 IF KK(R,S)<KK(FF(Q9),GG(Q9)) THEN 4210
4150 FOR M=1 TO A
4160 IF FF(M)<>R THEN 4190
4170 IF GG(M)=S THEN 4210
4180 NEXT M
4190 FF(Q9)=R
4200 GG(Q9)=S
4210 NEXT S
