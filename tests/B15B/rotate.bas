...
420 PRINT
430 PRINT "Start alt.  "; USING"###";H0;"    Az. ";USING"###";A0
440 PRINT "Ending alt. ";USING "###";H;"    Az. ";USING"###";A
450 END
460 '
470 IF LT>=24 THEN LT=LT-24
480 PRINT " ";USING "##";INT(LT);"h ";USING"##";(LT-INT(LT))*60;"m ";
490 PRINT "    Rotation ";USING"###.##";XX;" deg/min "
500 RETURN
