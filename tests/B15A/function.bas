...
1010 rem PRINT "DATE$: <"; DATE$; ">"
1020 rem PRINT "TIME$: <"; TIME$; ">"
...
1150 rem PRINT "SPACE$(5): <"; SPACE$(5); ">"
1160 rem PRINT "STRING$(5,X): <"; STRING$(5,"X"); ">"
...
1200 rem PRINT "TICK(): "; TICK()
1202 INPUT "Paused";X$
1210 PRINT "VAL(X): "; VAL("X")
1230 rem PRINT "ERR: "; ERR
1240 rem PRINT "ERL: "; ERL
1250 PRINT "LEN(0123456789): "; LEN("0123456789")
1260 rem PRINT "CSNG(-2.2): "; CSNG(-2.2)
...
1302 INPUT "Paused";X$
1310 rem PRINT "OCT$(27): <"; OCT$(27); ">"
1320 rem PRINT "CINT(-2.2): "; CINT(-2.2)
1330 PRINT "ASC(0123456789): "; ASC("0123456789")
1335 rem rest is unimplemented
1336 end
