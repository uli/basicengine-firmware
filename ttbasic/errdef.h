...
ESTR(ERR_TSF, "Failed to initialize synthesizer")
...
ESTR(ERR_FONT, "Font error")
ESTR(ERR_NOEXIT, "EXIT failed")
ESTR(ERR_OS, "OS error")
ESTR(ERR_DATA_ABORT, "Data Abort")
